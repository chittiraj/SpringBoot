...
@Tag(
		name = "CRM Application Rest APIs for the Resources",
		description = "- getAllLeads, getLeadById, createLead, updateLead, getCountAndOrderByStatus, deleteLead"
		)
@Validated
@RestController
...
public class LeadController {
	...
	//get all leads
	@Operation(
			summary = "GET All LEADS - REST API",
			description ="Get All leads REST API is used to get all leads for the API"
			)
	@ApiResponse(
			responseCode = "200",
	...
	@Operation(
			...
			description ="Get by ID is used to get, user given id same to database for the API"
			)
	@ApiResponse(
			responseCode = "200",
			description = "HTTP Status is OK"
	...
	@Operation(
			summary = "CREATE LEAD - REST API",
			description ="Create lead is used to post the new lead for the API"
			)
	@ApiResponse(
			responseCode = "200",
			description = "HTTP Status is OK"
	...
	//update the lead
	@Operation(
			summary = "UPDATE LEAD - REST API",
			description ="Update lead is used to put the details for the API"
			)
	@ApiResponse(
			responseCode = "200",
			description = "HTTP Status is OK"
	...
	//count all leads
	@Operation(
			summary = "COUNT LEAD - REST API",
			description ="Count leads REST API is used to count the leads for the API"
			)
	@ApiResponse(
			responseCode = "200",
			description = "HTTP Status is OK"
	...
	@Operation(
			summary = "GET LEAD STATUS - REST API",
			description ="Get Lead status is used to check the status to get the matched status for the API"
			)
	@ApiResponse(
			responseCode = "200",
			description = "HTTP Status is OK"
	...
	@Operation(
			summary = "DELETE LEAD - REST API",
			description ="Delete lead is used to delete the lead from the DB For the API"
			)
	@ApiResponse(
			responseCode = "200",
			description = "HTTP Status is OK"
